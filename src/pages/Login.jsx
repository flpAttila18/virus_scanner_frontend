...
import { FiMail, FiLock, FiEye, FiEyeOff, FiShield, FiZap, FiActivity } from 'react-icons/fi';
import 'bootstrap/dist/css/bootstrap.min.css';
import '../cssFolder/register.css'; // Ugyanazt a CSS-t használjuk a konzisztens design miatt
        ...
        <div className="register-page-bg d-flex align-items-center justify-content-center min-vh-100 px-3">
            <div className="container" style={{ maxWidth: '1200px' }}>
                <div className="row align-items-center g-5">
                    ...
                    {/* BAL OLDAL - INFORMÁCIÓK ÉS LOGÓ (Megegyezik a regisztrációssal) */}
                            ...
                            <form>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="input-group custom-input-group">
                                        ...
                                        <input type="email" className="form-control" placeholder="Írd be az E-mail címed" required />
                                    </div>
                                </div>
                                ...
                                <div className="mb-3">
                                    <div className="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <a href="#" className="text-primary small text-decoration-none">Elfelejtetted?</a>
                                    </div>
                                    <div className="input-group custom-input-group">
                                        <span className="input-group-text"><FiLock /></span>
                                        <input type={showPassword ? "text" : "password"} className="form-control" placeholder="Írd be a jelszavad" required />
                                ...
                                <div className="form-check mb-4 small text-start">
